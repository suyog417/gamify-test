          ...
          children: [
            Container(
                ...
                child: RichText(
                  ...
                  text: const TextSpan(
                      text: "k\n",
                      style: TextStyle(fontSize: 102, fontWeight: FontWeight.w900),
                      children: [
                        TextSpan(text: "kGamify", style: TextStyle(fontSize: 38)),
                      ]),
                )),
            Padding(
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                            ...
                            borderSide:
                                BorderSide(color: Colors.black.withOpacity(0.5), width: 0.0))),
                    obscureText: true,
                  ),
                  const Divider(
                    color: Colors.transparent,
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (Hive.box("UserData").get('personalInfo', defaultValue: null) != null) {
                        ...
                        ScaffoldMessenger.of(context)
                            .showSnackBar(const SnackBar(content: Text("User doesnt exist.")));
                      }
                    },
                        ...
                        ..onTap = () {
                          ...
                          Navigator.push(
                              ...
                              CupertinoDialogRoute(
                                  builder: (context) => const SignIn(), context: context));
                        },
                    ),
                    textAlign: TextAlign.center,
                  )
