...
void main() async {
  ...
  OneSignal.initialize(dotenv.env['OneSignalAppID']!);
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      child: MaterialApp(
        ...
        locale: Hive.box("UserData").get("locale", defaultValue: null) == null
            ? Locale(Platform.localeName)
            : Locale(Hive.box("UserData").get("locale", defaultValue: null)),
